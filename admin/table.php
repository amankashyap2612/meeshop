<?php
	...
	if(!isset($_SESSION['meesho2']) && $_SESSION['meesho2'] == null){
	...
	<tbody> 
		...
		?>
			<tr> 
				...
				<td><a href="product.php?update=<?php echo $row['id'];?> "onclick="return confirm('Are you sure you want to Update?')"><i class="fa fa-pencil text-body" style="font-size:20px"></i> Update</a></td>
				<td><a href="ajax/delete.php?del=<?php echo $row['id']?> "onclick="return confirm('Are you sure you want to delete?')"<i class="fa fa-trash-o text-danger" style="font-size:20px"></i> Delete</a></td>				
			</tr> 
		<?php } ?>
	</tbody> 
	</table>
