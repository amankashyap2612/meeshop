...
$sql ="insert into order_table(id,user_id,user_name,product_id,Productname,price,quantity,total,isconfirm
)values('','".$user."','".$name."','".$pid."','".$product."','".$pr."','".$quantity."','".$total."', 0)";
...
<a href='http://localhost/meesho/confermation.php?uid=".$user."&oid=".$last_id."' style='padding:6px; background: black; color: grey;  border-radius: 30px; width: 200px;
margin-top:10px;
'>Confermation</a>
</div>
